...
public class getTimeStamp_fromPcapFiles {

    private static final int COUNT = 100;

    private static final String PCAP_FILE_KEY = getTimeStamp_fromPcapFiles.class.getName() + ".pcapFile";
...
//                System.out.println(handle.getTimestamp().getNanos());
                ...
                System.out.println("In nano seconds: " + time);
