...
//Function to calculate average inter-arrival time between packets with Destination IP and Port with random interarrival times.
public class process_stringIP_Port_randomTime {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final StreamingFileSink<String> sink = StreamingFileSink.<String>forRowFormat(new Path("src/main/resources/output_randomTime"), new SimpleStringEncoder<String>("UTF-8"))
                .withRollingPolicy(
...
//                System.out.println("EOF");
    ...
    //Random number generating function: returns a random number in between 10000 and 400000 nano seconds
    private static long getRandomNumber() {
        return (long) ((Math.random() * (400000 - 10000)) + 10000);
    }
