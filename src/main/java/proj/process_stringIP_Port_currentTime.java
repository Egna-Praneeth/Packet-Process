...
public class process_stringIP_Port_currentTime {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<String> outputstream = dataStream2
                ...
                .process(new CountCurrentTimewise3());

        // Saving the packets in a file
        final StreamingFileSink<String> sink = StreamingFileSink.<String>forRowFormat(new Path("src/main/resources/output_curtime"), new SimpleStringEncoder<String>("UTF-8"))
                .withRollingPolicy(
